    ...
    $.fn.ttwMusicPlayer = function (playlist, userOptions) {
        ...
        interfaceMgr = function () {
            ...
            function buildInterface() {
                ...
                //I would normally use the templating music-player for something like this, but I wanted to keep this music-player's footprint as small as possible
                markup = '<div class="ttw-music-player">' +
                    ...
                    '            <div class="main">' +
                    '                <i class="previous jp-previous fa fa-backward control-btn"></i>' +
                    '                <i class="play jp-play fa fa-play control-btn"></i>' +
                    '                <i class="pause jp-pause fa fa-pause control-btn"></i>' +
                    '                <i class="next jp-next fa fa-forward control-btn"></i>' +
